...
$(window).on("scroll", function() {
    ...
    ($(window).scrollTop() > 1287 && $(window).scrollTop() < 1968) {
        $(".header").addClass("actives");

    } else if 
    ($(window).scrollTop() > 1968 && $(window).scrollTop() < 3270) {
        $(".header").removeClass("actives");

    } else if 
    ($(window).scrollTop() > 3270 && $(window).scrollTop() < 6204) {
        $(".header").addClass("actives");
...
$(window).on("scroll", function() {
    if($(window).scrollTop() > 555 && $(window).scrollTop() < 810) {
        $(".main-nav__item>a").addClass("active-scrolls");

    } else if 
    ($(window).scrollTop() > 810 && $(window).scrollTop() < 1287) {
        $(".main-nav__item>a").removeClass("active-scrolls");

    } else if 
    ($(window).scrollTop() > 1287 && $(window).scrollTop() < 2068) {
        $(".main-nav__item>a").addClass("active-scrolls");

    } else if 
    ($(window).scrollTop() > 2068 && $(window).scrollTop() < 3270) {
        $(".main-nav__item>a").removeClass("active-scrolls");

    } else if 
    ($(window).scrollTop() > 3270 && $(window).scrollTop() < 6200) {
        $(".main-nav__item>a").addClass("active-scrolls");
...
$(window).on("scroll", function() {
    if($(window).scrollTop() > 555 && $(window).scrollTop() < 810) {
        $(".main-nav__item--cta>a").addClass("active-contacts");

    } else if 
    ($(window).scrollTop() > 810 && $(window).scrollTop() < 1287) {
        $(".main-nav__item--cta>a").removeClass("active-contacts");
